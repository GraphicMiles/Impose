# Nova Agent Bridge (companion extension)

Lets the Nova web app read pages and perform your approved actions in
...
4. Open Nova, press the puzzle button in the top bar. It shows green
...
2. In Nova: Agent actions → pick the tab → Read page → Threads.
3. Draft with Nova (or type the reply yourself) and review the text.
...
- Host access, Nova origin only for the bridge; `x.com` and
...
- `content/nova-bridge.js` — same-origin page relay, Nova origin only.
